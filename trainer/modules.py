...
def locate_energy(locate_net, dataloader, device = 'cpu', params = None):
    ...
    if params['locate']['type'] == 'subtraction':
        ...
        for pairs in tqdm(dataloader):
            ...
            output, hidden_states = locate_net.locate_method.energynet.energy_model.representation_model(inputs)
            locate_result = locate_net.locate_method.locate(inputs, output, hidden_states)
